...
var _merchant_transactions = require("./merchant_transactions");
...
var _super_admins = require("./super_admins");
...
function initModels(sequelize) {
    ...
    var merchant_transactions = _merchant_transactions(sequelize, DataTypes);
    ...
    var super_admins = _super_admins(sequelize, DataTypes);
    ...
    merchant_transactions.belongsTo(merchants, {as: "merchant", foreignKey: "merchant_id"});
    merchants.hasMany(merchant_transactions, {as: "merchant_transactions", foreignKey: "merchant_id"});
