...
const adminConfig = require("../_config/admin-redis");
Leaderboard = (function () {
    ...
    function Leaderboard(leaderboardName, options, isSuperAdmin = false) {
        ...
        const redisOptions = {
            host: isSuperAdmin ? adminConfig.host : config.host,
            port: isSuperAdmin ? adminConfig.port : config.port,
            prefix: isSuperAdmin ? adminConfig.prefix : config.prefix,
            // password: isSuperAdmin ? adminConfig.password : config.password,
        };
