...
<title>Videowhizz - Default Player</title>
<link rel="shortcut icon" href="common/images/favicon.png" />
<link href='https://fonts.googleapis.com/css?family=Roboto:300,400,600,800' rel='stylesheet' type='text/css'>
<link rel="stylesheet" type="text/css" href="player1/css/icomoon.css">
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<link rel="stylesheet" type="text/css" href="common/css/bootstrap.min.css">
<link rel="stylesheet" type="text/css" href="common/css/modal-style.css">
<link rel="stylesheet" href="player1/css/bootstrap-slider.css">
<script type='text/javascript' src="common/js/bootstrap-slider.js"></script>
<script type='text/javascript' src="common/js/bootstrap.min.js"></script>
<link rel="stylesheet" type="text/css" href="player1/css/player-theme.css">
<!------------ poster background css start -------------->
<style type="text/css">
.poster {
	/*background-image:url(common/images/black.jpg);*/
	background-image: url(player1/images/poster.jpg);
}
</style>
...
<div class="top-bar-layout">
    ...
    <div class="col-xs-10 padding0">
      <div class="md17 sm16 xs13 w400 vidoe-title">
      <span class="title-bar text-color"> Video Name</span>
      </div>
    </div>
    <div class="col-xs-2 text-right padding0">
        <a href="javascript:" class="md24 sm24 xsem20 fullscreen-btn">
...
<div class="ceneter-play-btn  bg4 playpause" onclick="playVideo()">
	<a href="javascript:" class="md26 sm24 xs18 text-color"><i class="icon-play"></i></a>
</div>
<!---------------------------- center play button start----------------------------------------> 
...
<!-- saglus logo Div -->
<div class="saglus-logo"> <img src="common/images/Saglus.png" class="img-responsive" /> </div>
<!-- saglus logo Div End -->
<!-- Ab Loop Slider -->
<div id="abloop-slider">
...
<div id="player-control" class="bg4 text-color">
    ...
    <div class="center-control clearfix">
      ...
      <div class="player-time-left hidden-mobile md15 sm15 xs14 w400 timer">
      <span id="current-time">0:00</span> </div>
      ...
      <div class="player-time-right hidden-mobile md15 sm15 xs14 w400 timer">
      <span id="duration-time">0:00</span></div>
    ...
    <div class="right-control clearfix">
      <ul id="video-control-right">
        <li class="mt2 Volume hidden-xs-video-control"> <a href="javascript:" class="text-color" id="volumebtn"><i class="icon-volume md17 sm15 xs14" aria-hidden="true"></i></a>
        ...
        <li class="dropdown hidden-xs-video-control"> <a href="javascript:" class="text-color dropdown-toggle" id="sharebtn" data-toggle="dropdown"><i class="icon-share md17 sm15 xs14" aria-hidden="true"></i></a>
        ...
        <li class="dropdown setting-dropdown hidden-xs-video-control"> <a href="javascript:" class="text-color dropdown-toggle" id="settingbtn"><i class="icon-setting md17 sm15 xs14" aria-hidden="true"></i></a>
		...
		<li class="abloop-iconmargin hidden-xs-video-control"><a href="javascript:"><i class="icon-ab-loop md21 sm21 xs18 abloop-active" aria-hidden="true"></i></a>
        </li>  
      </ul>
    </div>
...
<div class="annotation-bar" style="display:none1;" align="center">
...
<div class="text-center">
  <button type="button" class="embed-btn md20 sm18 xs16 w500">Copy</button>
</div>
</div>
</div>
<!---------------------------- Embed Popup end ----------------------------------------> 
...
<div id="email-modal" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog email-modal-size email-form">
    ...
    <div class="form-group">
      <input type="Email" class="form-control" placeholder="Email this video link" id="pwd">
    </div>
    <div class="form-group">
      <input type="text" class="form-control" id="pwd" value="https://youtu.be/Qlt-VuchLQo">
    </div>
    <div class="form-group mb0 xsmb0">
      <textarea name="Message" class="form-control" cols="" rows="5" placeholder="Hi, Type your message here"></textarea>
    </div>
    <div class="text-center">
      <button type="button" class="embed-btn md20 sm18 xs16 w500">Send</button>
    </div>
  </div>
</div>
<!---------------------------- Email Popup end ----------------------------------------> 
...
<script src="player1/js/script.js"></script> 
